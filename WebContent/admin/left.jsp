		...
		<div class="menu">
			<div class="menuParent">
				...
				<div class="menuList">
					<div>
						<a target="mainAction"
							href="${pageContext.request.contextPath}/admin/addUser.jsp">添加管理员</a>
					</div>
					<div>
						<a target="mainAction"
							href="${pageContext.request.contextPath}/admin/adminServlet?method=list"">查看管理员信息</a>
					</div>
				</div>
			</div>
			<div class="menuParent">
			...
			<div class="menuParent">
				...
				<div class="menuList">
					<div>
						<a target="mainAction"
							href="product/property/productPropertyServlet?method=toAdd">添加商品属性</a>
					</div>
					<div>
						<a target="mainAction"
							href="product/property/productPropertyServlet?method=list">查看商品属性</a>
					</div>
				</div>
			</div>
			<div class="menuParent">
