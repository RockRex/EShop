...
<body>
  ...
  -->
	<div class="container">
		<h1 class="text-centertext-danger">添加商品属性选项</h1>
		<form id="myForm" role="form" action="productOptionServlet?method=add"
			...
			<div class="form-groupcol-md-12">
				<label id="label1" class="col-md-2 control-label" for="name">选项
					序号：</label>
				<div class="col-md-10">
			...
			<div class="form-groupcol-md-12">
				<div class="col-md-offset-2col-md-10">
					<button type="submit" id="subt" class="btn btn-primary btn-sm">提交
					</button>
				</div>
			</div>
			<div class="form-groupcol-md-12">
				<div class="col-md-offset-2col-md-10">${param.status==1?"<div
					class='alert alert-danger' role='alert'>添加分类成功</div>":"" }</div>
			</div>
