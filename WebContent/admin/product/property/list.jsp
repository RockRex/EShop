...
<script type="text/javascript">
					...
					.post(
							...
							function(data) {
								if (data != null && data.length > 0) {
									var content = "<div class='col-sm-2'><select name='parentId' class='form-control' onchange='chType(this)' id='type0'><option value='0'>-- 请 选择父类 --</option>";
	...
	function showProperty(obj) {
		...
		$
				.post(
						"../property/productPropertyServlet",
						{
							method : "getProperty",
							id : id
						},
...
<body>
	<div class="container">
		...
		<div class="form-groupcol-md-12">${param.status==1?"<div
			class='alert alert-success' role='alert'> 修改属性成功</div>":"" }</div>
	</div>
</body>
</html>
