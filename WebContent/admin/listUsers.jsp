        ...
        <table class="table table-striped"> 
          ...
          <!-- forEach遍历出adminBeans --> 
            ...
            <tr> 
              ...
              <td>${item.salt }</td> 
              <td><a 
                href="${pageContext.request.contextPath}/admin/adminServlet?method=toUpdate&id=${item.id }">修改
</a></td> 
              <td><a 
             
  href="${pageContext.request.contextPath}/admin/adminServlet?method=delete&id=${item.id }">删除
</a></td> 
            </tr> 
          </c:forEach> 
        </table> 
